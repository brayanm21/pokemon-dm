...
This is the data part of the application, so we simply import it to https://github.com/brayanm21/pokemon-ui which will take care of taking the data and displaying it visually
